...
class PartyPrivateEvent extends PartyEvent{
		...
		if(!$this->started){
			...
			if($this->currentMatch === null){
				...
				if($size === 1){
					...
					$this->ended = true;
				}else if($this->currentTick === MineceitUtil::secondsToTicks(10) || $this->secondsAfterLastMatch === 5){
	...
	public function removeFromEvent(MineceitPlayer $player) : void{
		...
		if($this->currentMatch !== null && $this->currentMatch->isPlayer($name)){
